  ...
  ({ className }, ref) => {
    ...
    return (
      <footer
        ref={ref}
        className={cn(
          'border-t backdrop-blur-md bg-white/20 border-white/30 mt-20',
          className
        )}
      >
        <div className="container mx-auto px-4 py-12">
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-8">
            ...
            <div className="lg:col-span-2">
              ...
              <p className="text-muted-foreground mb-6 max-w-md">
                A modern morphism design system inspired by ThinkPad's iconic design language. 
              ...
              <div className="flex space-x-2">
                ...
                <Button variant="ghost" size="icon-sm" aria-label="Discord">
                  <svg className="w-4 h-4" fill="currentColor" viewBox="0 0 24 24">
          ...
          <div className="border-t border-white/20 mt-12 pt-8 flex flex-col md:flex-row justify-between items-center">
            <p className="text-muted-foreground text-sm">
              © {currentYear} ThinkPad UI. All rights reserved.
            </p>
